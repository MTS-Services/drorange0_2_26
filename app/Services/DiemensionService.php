...
class DiemensionService
{
    public function __construct(public Diemension $model)
    {
    }
    ...
    public function getDimensionsCountByServiceType(int $serviceTypeId): int
    {
        return $this->model->where('service_type_id', $serviceTypeId)->count();
    }
}
