        ...
        <section
            ...
            <div className="max-w-xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Link href={route('free-estimate')}
                        className="bg-white text-blue-700 font-inter font-bold px-7 py-3 rounded-xl hover:bg-blue-50 transition-colors text-sm shadow-lg">Get
                        Free Estimate</Link>
                    <Link href={route('contact')}
                        className="border-2 border-white text-white font-inter font-bold px-7 py-3 rounded-xl hover:bg-white hover:text-blue-700 transition-colors text-sm">Contact
                        Us</Link>
                </div>
            </div>
        </section>
