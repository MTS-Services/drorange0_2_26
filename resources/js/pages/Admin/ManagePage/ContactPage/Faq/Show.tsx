  ...
  return (
    <AdminLayout activeSlug="contact-faq">
      ...
      <div className="flex justify-between mb-6">
        ...
        <Link href={route('admin.pm.contact-faq.index')}>
          <Button>Back</Button>
        </Link>
      </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4 pt-2">
                  <div className="flex flex-col gap-3 lg:flex-row lg:gap-2">
                    <Link href={route('admin.pm.contact-faq.edit', item.id)} className="flex-1">
                      <Button className="w-full">Edit</Button>
                    </Link>
                    <Link href={route('admin.pm.contact-faq.index')} className="flex-1">
