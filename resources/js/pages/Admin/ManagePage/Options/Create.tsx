...
export default function Create({ serviceTypes }: Props) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    post(route('admin.sm.option.store'), {
      onSuccess: () => toast.success('Option created successfully'),
      onError: () => toast.error('Failed to create option. Please check the form.'),
    });
  };
  ...
  return (
    <AdminLayout activeSlug="option">
      ...
      <div className="flex justify-between mb-6">
        <h1 className="text-2xl font-bold">Create Option</h1>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <h2 className="text-2xl font-bold">Option Details</h2>
        </CardHeader>
        <CardContent>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Textarea
                        ...
                        rows={4}
                        placeholder="Optional description of the option"
                      />
