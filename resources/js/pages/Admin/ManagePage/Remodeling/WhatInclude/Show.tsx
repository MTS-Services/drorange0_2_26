...
export default function Show({ include }: Props) {
  return (
    <AdminLayout activeSlug="remodeling-what-include">
      <Head title="Remodeling What Include Details" />

      <div className="flex justify-between mb-6">
        <h1 className="text-2xl font-bold">Remodeling What Include Details</h1>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <p className="font-medium">{include.subtitle}</p>
                  </div>

                  <div className="grid gap-2">
                    <p className="text-sm text-muted-foreground">Icon</p>
                    {include.icon_url ? (
                      <img src={include.icon_url} alt={include.title} className="h-16 w-16 rounded border object-contain" />
                    ) : (
              ...
              <Card>
                ...
                <CardContent className="space-y-4 pt-2">
                  <div className="flex flex-col gap-3 lg:flex-row lg:gap-2">
                    <Link href={route('admin.pm.remodeling-what-include.edit', include.id)} className="flex-1">
                      <Button className="w-full">Edit</Button>
                    </Link>
                    <Link href={route('admin.pm.remodeling-what-include.index')} className="flex-1">
