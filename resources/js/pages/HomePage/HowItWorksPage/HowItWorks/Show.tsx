  ...
  return (
    <AdminLayout activeSlug="how-it-work">
      ...
      <div className="flex justify-between mb-6">
        <h1 className="text-2xl font-bold">How It Works Details</h1>
        <Link href={route('admin.pm.how-it-works.index')}>
          <Button>Back</Button>
        </Link>
      </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4 pt-2">
                  <div className="flex flex-col gap-3 lg:flex-row lg:gap-2">
                    <Link href={route('admin.pm.how-it-works.edit', item.id)} className="flex-1">
                      <Button className="w-full">Edit</Button>
                    </Link>
                    <Link href={route('admin.pm.how-it-works.index')} className="flex-1">
