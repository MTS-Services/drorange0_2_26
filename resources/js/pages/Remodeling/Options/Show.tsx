...
interface Props {
    option: RemodelingOption;
}

export default function Show({ option }: Props) {
    return (
        <AdminLayout activeSlug="remodeling-option">
            <Head title="Remodeling Option Details" />

            <div className="flex justify-between mb-6">
                <h1 className="text-2xl font-bold">Remodeling Option Details</h1>
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <h2 className="text-2xl font-bold">Remodeling Option</h2>
                </CardHeader>
                <CardContent>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4 pt-2">
                                    <div className="flex flex-col gap-3 lg:flex-row lg:gap-2">
                                        <Link href={route('admin.pm.remodeling-option.edit', option.id)} className="flex-1">
                                            <Button className="w-full">Edit</Button>
                                        </Link>
                                        <Link href={route('admin.pm.remodeling-option.index')} className="flex-1">
