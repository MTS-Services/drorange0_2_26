...
export default function Create() {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        post(route('admin.pm.remodeling-why-choose.store'), {
            forceFormData: true,
            onSuccess: () => toast.success('Why Choose item created successfully'),
    ...
    return (
        <AdminLayout activeSlug="remodeling-why-choose">
            <Head title="Create Why Choose Item" />

            <div className="flex justify-between mb-6">
                <h1 className="text-2xl font-bold">Create Why Choose Item</h1>
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <CardTitle>Why Choose Details</CardTitle>
                </CardHeader>
                <CardContent>
