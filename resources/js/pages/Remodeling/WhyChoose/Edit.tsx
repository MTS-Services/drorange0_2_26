...
export default function Edit() {
    const { props } = usePage<{ option: RemodelingWhyChoose }>();
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        post(route('admin.pm.remodeling-why-choose.update', option?.id ?? 1), {
            forceFormData: true,
            onSuccess: () => toast.success('Why Choose item updated successfully'),
